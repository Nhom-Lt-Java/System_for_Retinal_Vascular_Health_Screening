      ...
      <Container>
        <Toolbar sx={{ px: 0 }}>
          ...
          <Box sx={{ display: "flex", gap: 1, alignItems: "center" }}>
            {!isDoctor ? (
              <>
                <Button color="inherit" sx={{ color: "#555" }} onClick={() => navigate("/upload")}>
                  Phân tích
                </Button>
                <Button color="inherit" sx={{ color: "#555" }} onClick={() => navigate("/history")}>
                  Lịch sử
                </Button>
              ...
              <>
                <Button color="inherit" sx={{ color: "#555" }} onClick={() => navigate("/doctor")}>
                  Thống kê
                </Button>
                <Button color="inherit" sx={{ color: "#555" }} onClick={() => navigate("/doctor/patients")}>
                  Bệnh nhân
                </Button>
              </>
            )}
